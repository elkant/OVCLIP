...
<html>
    <head>
        <title>Multiple sites Reports</title>
...
<%}}%>                  
		...
		<div class="wrapper" >
			...
			<h2 style="text-align: center;"><span>OVC LIP SUPERVISION MULTIPLE SITES REPORT </span></h2>
			<br/>
			<br/>
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					
					<form class="login active" action="multiplesitesreport" id="formid" style="width:400px;">
