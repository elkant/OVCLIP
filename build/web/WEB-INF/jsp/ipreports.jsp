...
<html>
    <head>
        <title>IP/CBO Reports (Excel)</title>
...
<%}}%>                  
		...
		<div class="wrapper" >
			...
			<h2 style="text-align: center;"><span>OVC LIP SUPERVISION IP/CBOs REPORT </span></h2>
			<br/>
			<br/>
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					
					<form class="login active" action="resultspercbo" id="formid" style="width:400px;">
