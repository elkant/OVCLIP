...
if(fulldates[1].equals("10")||fulldates[1].equals("11")||fulldates[1].equals("12")){ quarters="1";}
         ...
         String bacgroundinfor="insert into backgroundinfor (backgroundid,cbo,site,staff_present,supervisor,ass_date,other_team_members,marks_table_id,year,period,ass_type) values "
                 + "(?,?,?,?,?,?,?,?,?,?,?)";
